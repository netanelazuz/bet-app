...
```
cd existing_repo
git remote add origin https://gitlab.com/sela-1119/students/netanelazuz/final_project/predictions.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/sela-1119/students/netanelazuz/final_project/predictions/-/settings/integrations)
